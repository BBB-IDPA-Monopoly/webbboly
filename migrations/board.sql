...
VALUES (1,1,60,'Parkanlage Martinsberggut',2,4,10,30,90,160,250,30,1, 'parkanlage_martinsberggut.jpg'), -- Brown 1
       (2,1,60,'Kappiinseli',4,8,20,60,180,320,450,30,3, 'kappiinseli.jpg'), -- Brown 2
       (3,2,100,'Kurpark',6,12,30,90,270,400,550,50,6, 'kurpark.jpg'), -- Light Blue 1
       (4,2,100,'Theaterplatz',6,12,30,90,270,400,550,50,8, 'theaterplatz.jpg'), -- Light Blue 2
       ...
       (8,3,160,'Spielplatz Kehl Baden',12,24,60,180,500,700,900,80,14, 'spielplatz_kehl_baden.jpg'), -- Pink 3
       (9,4,180,'Mellingerstrasse',14,28,70,200,550,700,900,90,16, 'mellingerstrasse.jpg'), -- Orange 1
       ...
       (15,6,260,'Limmat Promenade',22,44,110,330,800,975,1150,130,26, 'limmatpromenade.jpg'), -- Yellow 1
       (16,6,260,'Bruggerstrasse',22,44,110,330,800,975,1150,130,27, 'bruggerstrasse.jpg'), -- Yellow 2
       (17,6,280,'Haselstrasse',24,48,120,360,850,1025,1200,140,29, 'haselstrasse.jpg'), -- Yellow 3
       (18,7,300,'Spielplatz Baldegg Baden',26,52,130,390,900,1100,1275,150,31, 'spielplatz_baldegg_baden.jpg'), -- Green 1
       (19,7,300,'Müsernstrasse',26,52,130,390,900,1100,1275,150,32, 'müsernstrasse.jpg'), -- Green 2
       (20,7,320,'Parkstrasse',28,56,150,450,1000,1200,1400,160,34,'parkstrasse.jpg'), -- Green 3
       (21,8,350,'Mättelipark',35,70,175,500,1100,1300,1500,175,37, 'mättelipark.jpg'), -- Blue 1
...
VALUES (13,'Bahnhof Baden','railroad',5, 100, 'bahnhof_baden.jpg'),
       (14,'Postautostation','railroad',15, 100, 'postautostation.jpg'),
       (15,'Lindenplatz','railroad',25, 100, 'lindenplatz.jpg'),
       (16,'Ziegelhau','railroad',35, 100, 'ziegelhau.jpg'),
       (17,'Kraftwerk Kappelerhof','utility',12, 75, 'kraftwerk_kappelerhof.jpg'),
       (18,'Power Tower','utility',28, 75, 'power_tower.jpg');
...
VALUES (1, 'Die Bank zahlt dir eine divide von 50$', 'chance', 'add.100', 1),
       ...
       (6, 'Du kommst ohne Busse aus dem Gefängnis frei.', 'chance', 'freeFromJail.1', 1),
...
VALUES (16, 'Rückzahlung einer Anleihe: Die Bank zahlt dir 25$', 'communityChest', 'add.25', 1),
       ...
       (23, 'Du kommst ohne Busse aus dem Gefängnis frei.', 'communityChest', 'freeFromJail.2', 1),
